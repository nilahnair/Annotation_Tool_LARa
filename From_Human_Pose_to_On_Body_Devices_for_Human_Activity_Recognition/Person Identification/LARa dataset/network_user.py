...
'''make sure to choose the network file based on the network you want to experiment. 
network.py refers to CNN-IMU
network_lstm.py refers to deepCNNLSTM network
'''
