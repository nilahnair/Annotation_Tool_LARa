...
class Modus_Selecter(object):
    ...
    def train(self, itera=1, testing=False):
        ...
        for iter_evl in range(itera):
            ...
            '''activate c_pos_val, c_neg_val for impact of activities experiment'''
            ...
            '''
            if c_pos_val[0] == 0:
                self.exp.log_scalar("standing_pf{}".format(iter_evl), c_pos_val[0])
            else:
                self.exp.log_scalar("standing_pf{}".format(iter_evl), c_pos_val[0]/(c_pos_val[0]+c_neg_val[0]))
            if c_pos_val[1] == 0:
                self.exp.log_scalar("walking_pf{}".format(iter_evl), c_pos_val[1])
            else:
                self.exp.log_scalar("walking_pf{}".format(iter_evl), c_pos_val[1]/(c_pos_val[1]+c_neg_val[1]))
            if c_pos_val[2] == 0:
                self.exp.log_scalar("cart_pf{}".format(iter_evl), c_pos_val[2])
            else:
                self.exp.log_scalar("cart_pf{}".format(iter_evl), c_pos_val[2]/(c_pos_val[2]+c_neg_val[2]))
            if c_pos_val[3] == 0:
                self.exp.log_scalar("handling_up_pf{}".format(iter_evl), c_pos_val[3])
            else:
                self.exp.log_scalar("handling_up_pf{}".format(iter_evl), c_pos_val[3]/(c_pos_val[3]+c_neg_val[3]))
            if c_pos_val[4] == 0:
                self.exp.log_scalar("handling_cen_pf{}".format(iter_evl), c_pos_val[4])
            else:
                self.exp.log_scalar("handling_cen_pf{}".format(iter_evl), c_pos_val[4]/(c_pos_val[4]+c_neg_val[4]))
            if c_pos_val[5] == 0:
                self.exp.log_scalar("handling_down_pf{}".format(iter_evl), c_pos_val[5])
            else:
                self.exp.log_scalar("handling_down_pf{}".format(iter_evl), c_pos_val[5]/(c_pos_val[5]+c_neg_val[5]))
            if c_pos_val[6] == 0:
                self.exp.log_scalar("synch_pf{}".format(iter_evl), c_pos_val[6])
            else:
                self.exp.log_scalar("synch_pf{}".format(iter_evl), c_pos_val[6]/(c_pos_val[6]+c_neg_val[6]))
            if c_pos_val[7] == 0:
                self.exp.log_scalar("none_pf{}".format(iter_evl), c_pos_val[7])
            else:
                self.exp.log_scalar("none_pf{}".format(iter_evl), c_pos_val[7]/(c_pos_val[7]+c_neg_val[7]))
            
            if c_neg_val[0] == 0:
                self.exp.log_scalar("standing_nf{}".format(iter_evl), c_neg_val[0])
            else:
                self.exp.log_scalar("standing_nf{}".format(iter_evl), c_neg_val[0]/(c_pos_val[0]+c_neg_val[0]))
            if c_neg_val[1] == 0:
                self.exp.log_scalar("walking_nf{}".format(iter_evl), c_neg_val[1])
            else:
                self.exp.log_scalar("walking_nf{}".format(iter_evl), c_neg_val[1]/(c_pos_val[1]+c_neg_val[1]))
            if c_neg_val[2] == 0:
                self.exp.log_scalar("cart_nf{}".format(iter_evl), c_neg_val[2])
            else:
                self.exp.log_scalar("cart_nf{}".format(iter_evl), c_neg_val[2]/(c_pos_val[2]+c_neg_val[2]))
            if c_neg_val[3] == 0:
                self.exp.log_scalar("handling_up_nf{}".format(iter_evl), c_neg_val[3])
            else:
                self.exp.log_scalar("handling_up_nf{}".format(iter_evl), c_neg_val[3]/(c_pos_val[3]+c_neg_val[3]))
            if c_neg_val[4] == 0:
                self.exp.log_scalar("handling_cen_nf{}".format(iter_evl), c_neg_val[4])
            else:
                self.exp.log_scalar("handling_cen_nf{}".format(iter_evl), c_neg_val[4]/(c_pos_val[4]+c_neg_val[4]))
            if c_neg_val[5] == 0:
                self.exp.log_scalar("handling_down_nf{}".format(iter_evl), c_neg_val[5])
            else:
                self.exp.log_scalar("handling_down_nf{}".format(iter_evl), c_neg_val[5]/(c_pos_val[5]+c_neg_val[5]))
            if c_neg_val[6] == 0:
                self.exp.log_scalar("synch_nf{}".format(iter_evl), c_neg_val[6])
            else:
                self.exp.log_scalar("synch_nf{}".format(iter_evl), c_neg_val[6]/(c_pos_val[6]+c_neg_val[6]))
            if c_neg_val[7] == 0:
                self.exp.log_scalar("none_nf{}".format(iter_evl), c_neg_val[7])
            else:
                self.exp.log_scalar("none_nf{}".format(iter_evl), c_neg_val[7]/(c_pos_val[7]+c_neg_val[7]))
            '''
            ...
            if testing:
                ...
                '''activate when experimenting on impact of activities'''
        ...
        if testing:
            ...
            if count_pos_test[0] == 0:
                self.exp.log_scalar("standing_ptest{}".format(iter_evl), count_pos_test[0])
            else:
                self.exp.log_scalar("standing_ptest{}".format(iter_evl), count_pos_test[0]/(count_pos_test[0]+count_neg_test[0]))
            if count_pos_test[1] == 0:
                self.exp.log_scalar("walking_ptest{}".format(iter_evl), count_pos_test[1])
            else:
                self.exp.log_scalar("walking_ptest{}".format(iter_evl), count_pos_test[1]/(count_pos_test[1]+count_neg_test[1]))
            if count_pos_test[2] == 0:
                self.exp.log_scalar("cart_ptest{}".format(iter_evl), count_pos_test[2])
            else:
                self.exp.log_scalar("cart_ptest{}".format(iter_evl), count_pos_test[2]/(count_pos_test[2]+count_neg_test[2]))
            if count_pos_test[3] == 0:
                self.exp.log_scalar("handling_up_ptest{}".format(iter_evl), count_pos_test[3])
            else:
                self.exp.log_scalar("handling_up_ptest{}".format(iter_evl), count_pos_test[3]/(count_pos_test[3]+count_neg_test[3]))
            if count_pos_test[4] == 0:
                self.exp.log_scalar("handling_cen_ptest{}".format(iter_evl), count_pos_test[4])
            else:
                self.exp.log_scalar("handling_cen_ptest{}".format(iter_evl), count_pos_test[4]/(count_pos_test[4]+count_neg_test[4]))
            if count_pos_test[5] == 0:
                self.exp.log_scalar("handling_down_ptest{}".format(iter_evl), count_pos_test[5])
            else:
                self.exp.log_scalar("handling_down_ptest{}".format(iter_evl), count_pos_test[5]/(count_pos_test[5]+count_neg_test[5]))
            if count_pos_test[6] == 0:
                self.exp.log_scalar("synch_ptest{}".format(iter_evl), count_pos_test[6])
            else:
                self.exp.log_scalar("synch_ptest{}".format(iter_evl), count_pos_test[6]/(count_pos_test[6]+count_neg_test[6]))
            if count_pos_test[7] == 0:
                self.exp.log_scalar("none_ptest{}".format(iter_evl), count_pos_test[7])
            else:
                self.exp.log_scalar("none_ptest{}".format(iter_evl), count_pos_test[7]/(count_pos_test[7]+count_neg_test[7]))
                
            self.exp.log_scalar("total_standing_ptest{}".format(iter_evl), count_pos_test[0])
            self.exp.log_scalar("total_walking_ptest{}".format(iter_evl), count_pos_test[1])
            self.exp.log_scalar("total_cart_ptest{}".format(iter_evl), count_pos_test[2])
            self.exp.log_scalar("total_handling_up_ptest{}".format(iter_evl), count_pos_test[3])
            self.exp.log_scalar("total_handling_cen_ptest{}".format(iter_evl), count_pos_test[4])
            self.exp.log_scalar("total_handling_down_ptest{}".format(iter_evl), count_pos_test[5])
            self.exp.log_scalar("total_synch_ptest{}".format(iter_evl), count_pos_test[6])
            
            if count_neg_test[0] == 0:
                self.exp.log_scalar("standing_ntest{}".format(iter_evl), count_neg_test[0])
            else:
                self.exp.log_scalar("standing_ntest{}".format(iter_evl), count_neg_test[0]/(count_pos_test[0]+count_neg_test[0]))
            if count_neg_test[1] == 0:
                self.exp.log_scalar("walking_ntest{}".format(iter_evl), count_neg_test[1])
            else:
                self.exp.log_scalar("walking_ntest{}".format(iter_evl), count_neg_test[1]/(count_pos_test[1]+count_neg_test[1]))
            if count_neg_test[2] == 0:
                self.exp.log_scalar("cart_ntest{}".format(iter_evl), count_neg_test[2])
            else:
                self.exp.log_scalar("cart_ntest{}".format(iter_evl), count_neg_test[2]/(count_pos_test[2]+count_neg_test[2]))
            if count_neg_test[3] == 0:
                self.exp.log_scalar("handling_up_ntest{}".format(iter_evl), count_neg_test[3])
            else:
                self.exp.log_scalar("handling_up_ntest{}".format(iter_evl), count_neg_test[3]/(count_pos_test[3]+count_neg_test[3]))
            if count_neg_test[4] == 0:
                self.exp.log_scalar("shandling_cen_ntest{}".format(iter_evl), count_neg_test[4])
            else:
                self.exp.log_scalar("handling_cen_ntest{}".format(iter_evl), count_neg_test[4]/(count_pos_test[4]+count_neg_test[4]))
            if count_neg_test[5] == 0:
                self.exp.log_scalar("handling_down_ntest{}".format(iter_evl), count_neg_test[5])
            else:
                self.exp.log_scalar("handling_down_ntest{}".format(iter_evl), count_neg_test[5]/(count_pos_test[5]+count_neg_test[5]))
            if count_neg_test[6] == 0:
                self.exp.log_scalar("synch_ntest{}".format(iter_evl), count_neg_test[6])
            else:
                self.exp.log_scalar("synch_ntest{}".format(iter_evl), count_neg_test[6]/(count_pos_test[6]+count_neg_test[6]))
            if count_neg_test[7] == 0:
                self.exp.log_scalar("none_ntest{}".format(iter_evl), count_neg_test[7])
            else:
                self.exp.log_scalar("none_ntest{}".format(iter_evl), count_neg_test[7]/(count_pos_test[7]+count_neg_test[7]))
            '''
        ...
        '''if experimenting for impact of activities activate the following'''
        '''
    ...
    def test(self, testing = False):
        ...
        '''activate the following for impact of activities experiment'''
