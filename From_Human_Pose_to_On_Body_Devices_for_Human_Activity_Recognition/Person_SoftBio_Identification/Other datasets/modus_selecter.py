   ...
   # def __init__(self, config, exp = None):
    ...
    def train(self, itera=1, testing=False):
        ...
        for iter_evl in range(itera):
            ...
            """use when using c_pos_val and c_neg_val for impact of activities"""
            ...
            #use when performing impact of activities 
            #use for pamap
            '''
            if c_pos_val[0] == 0:
        ...
        if testing:
            ...
            #use for impact of activities experiment
            #pamap
            '''
    ...
    def test(self, testing = False):
        ...
        #activate for impact of activities
