...
train_data_files = ['/Opportunity/dataset/S1-ADL1.dat', #0
                    '/Opportunity/dataset/S1-ADL2.dat', #1
                    '/Opportunity/dataset/S1-ADL3.dat', #2
                    '/Opportunity/dataset/S2-ADL1.dat', #3
                    '/Opportunity/dataset/S2-ADL2.dat', #4
                    '/Opportunity/dataset/S2-ADL3.dat', #5
                    '/Opportunity/dataset/S3-ADL1.dat', #6
                    '/Opportunity/dataset/S3-ADL2.dat', #7
                    '/Opportunity/dataset/S3-ADL3.dat', #8
                    '/Opportunity/dataset/S4-ADL1.dat', #9
                    '/Opportunity/dataset/S4-ADL2.dat', #10
                    '/Opportunity/dataset/S4-ADL3.dat'  #11
                    ]
val_data_files = ['/Opportunity/dataset/S1-ADL4.dat', #0
                  '/Opportunity/dataset/S2-ADL4.dat', #1
                  '/Opportunity/dataset/S3-ADL4.dat', #2
                  '/Opportunity/dataset/S4-ADL4.dat'  #3
                 ]
test_data_files = ['/Opportunity/dataset/S1-ADL5.dat', #0
                  '/Opportunity/dataset/S2-ADL5.dat',  #1
                  '/Opportunity/dataset/S3-ADL5.dat',  #2
                  '/Opportunity/dataset/S4-ADL5.dat'   #3
                 ]
drill_data_files = ['/Opportunity/dataset/S1-Drill.dat', #0
                  '/Opportunity/dataset/S2-Drill.dat',  #1
                  '/Opportunity/dataset/S3-Drill.dat',  #2
                  '/Opportunity/dataset/S4-Drill.dat'   #3
                 ]
...
if __name__ == '__main__':
    ...
    base_directory = '.../locomotions/input/'
    #base_directory = '.../gesture/input/'
