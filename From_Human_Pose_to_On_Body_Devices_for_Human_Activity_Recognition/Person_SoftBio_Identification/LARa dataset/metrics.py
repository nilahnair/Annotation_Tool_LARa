...
class Metrics(object):
    ...
    '''activate correct function definition based on whether 
    attribute representation is required'''
    ...
    def __init__(self, config, dev):
        ...
        '''
        for attribute representation activate the commented section. 
        note that the reformating based on number of attributes is to ensure that
        similar representations have the same center
        '''
        '''
        ...
        self.results = {'acc': 0, 'f1_weighted': 0, 'f1_mean': 0, 'predicted_classes': 0, 'precision': 0, 
                        'recall': 0, 'acc_attrs': 0, 'precision_attr': 0, 'recall_attr': 0,}
        '''
        
        #comment the below line in case of attribute representation
        self.results = {'acc': 0, 'f1_weighted': 0, 'f1_mean': 0, 'predicted_classes': 0, 'precision': 0,
                        'recall': 0}
    ...
    def efficient_distance(self, predictions):
        ...
        This code consist of both euclidean and BCELOSS set up. These functions are used to determine
        the centers. 
        '''
